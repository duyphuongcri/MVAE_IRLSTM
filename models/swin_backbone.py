...
#     model = SwinEncoder(img_size=(80,96,80), in_channels=2, feature_size=48)
#     x = torch.ones((1, 2, 80, 96, 80))
#     out = model(x)

#     model2 = SwinDecoder(feature_size=48, out_channels=2)
#     out  = model2(out)
#     print(out.shape)